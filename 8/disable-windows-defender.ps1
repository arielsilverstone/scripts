...
Takeown-Registry("HKLM\SYSTEM\CurrentControlSet\Services\WinDefend")
...
Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\SENS" "Start" 4
Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\SENS" "AutorunsDisabled" 3
...
# Disable Windows Defender Cloud - Spynet
...
Write-Output ""
Write-Output "Disable Windows Defender - Ready"
Write-Output ""
